...
public class DashboardPage {
    ...
    private static final SelenideElement personalAccount = $("[data-test-id=dashboard]");
    private static final SelenideElement refreshButton = $("data-test-id=action-reload");
